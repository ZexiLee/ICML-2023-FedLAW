...
class ResNet_cifar_fedlaw(ReparamModule):
    def __init__(self, block, num_blocks, num_classes=10):
        super(ResNet_cifar_fedlaw, self).__init__()
        self.in_planes = 16
...
class WResNet_cifar_fedlaw(ReparamModule):
    def __init__(self, block, num_blocks, k, num_classes=10):
        super(WResNet_cifar_fedlaw, self).__init__()
        self.in_planes = 16*k
...
# For fedlaw
def ResNet20_fedlaw(num_classes):
    depth = 20
    n = (depth - 2) // 6
    return ResNet_cifar_fedlaw(BasicBlock, [n,n,n], num_classes)

def ResNet20_noshort_fedlaw(num_classes):
    depth = 20
    n = (depth - 2) // 6
    return ResNet_cifar_fedlaw(BasicBlock_noshortcut, [n,n,n], num_classes)

def ResNet32_noshort_fedlaw(num_classes):
    depth = 32
    n = (depth - 2) // 6
    return ResNet_cifar_fedlaw(BasicBlock_noshortcut, [n,n,n], num_classes)

def ResNet44_noshort_fedlaw(num_classes):
    depth = 44
    n = (depth - 2) // 6
    return ResNet_cifar_fedlaw(BasicBlock_noshortcut, [n,n,n], num_classes)

def ResNet50_16_noshort_fedlaw(num_classes):
    depth = 50
    n = (depth - 2) // 6
    return ResNet_cifar_fedlaw(BasicBlock_noshortcut, [n,n,n], num_classes)

def ResNet56_fedlaw(num_classes):
    depth = 56
    n = (depth - 2) // 6
    return ResNet_cifar_fedlaw(BasicBlock, [n,n,n], num_classes)

def ResNet56_noshort_fedlaw(num_classes):
    depth = 56
    n = (depth - 2) // 6
    return ResNet_cifar_fedlaw(BasicBlock_noshortcut, [n,n,n], num_classes)

def ResNet110_fedlaw(num_classes):
    depth = 110
    n = (depth - 2) // 6
    return ResNet_cifar_fedlaw(BasicBlock, [n,n,n], num_classes)

def ResNet110_noshort_fedlaw(num_classes):
    depth = 110
    n = (depth - 2) // 6
    return ResNet_cifar_fedlaw(BasicBlock_noshortcut, [n,n,n], num_classes)

def WRN56_2_fedlaw(num_classes):
    depth = 56
    n = (depth - 2) // 6
    return WResNet_cifar_fedlaw(BasicBlock, [n,n,n], 2, num_classes)

def WRN56_4_fedlaw(num_classes):
    depth = 56
    n = (depth - 2) // 6
    return WResNet_cifar_fedlaw(BasicBlock, [n,n,n], 4, num_classes)

def WRN56_8_fedlaw(num_classes):
    depth = 56
    n = (depth - 2) // 6
    return WResNet_cifar_fedlaw(BasicBlock, [n,n,n], 8, num_classes)

def WRN56_2_noshort_fedlaw(num_classes):
    depth = 56
    n = (depth - 2) // 6
    return WResNet_cifar_fedlaw(BasicBlock_noshortcut, [n,n,n], 2, num_classes)

def WRN56_4_noshort_fedlaw(num_classes):
    depth = 56
    n = (depth - 2) // 6
    return WResNet_cifar_fedlaw(BasicBlock_noshortcut, [n,n,n], 4, num_classes)

def WRN56_8_noshort_fedlaw(num_classes):
    depth = 56
    n = (depth - 2) // 6
    return WResNet_cifar_fedlaw(BasicBlock_noshortcut, [n,n,n], 8, num_classes)

def WRN110_2_noshort_fedlaw(num_classes):
    depth = 110
    n = (depth - 2) // 6
    return WResNet_cifar_fedlaw(BasicBlock_noshortcut, [n,n,n], 2, num_classes)

def WRN110_4_noshort_fedlaw(num_classes):
    depth = 110
    n = (depth - 2) // 6
    return WResNet_cifar_fedlaw(BasicBlock_noshortcut, [n,n,n], 4, num_classes)
